...
--
-- Table structure for table `sync_terminal`
--

DROP TABLE IF EXISTS `sync_terminal`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `sync_terminal` (
...
) ENGINE=InnoDB AUTO_INCREMENT=5487 DEFAULT CHARSET=latin1;
...
-- Dump completed on 2025-04-26 17:58:07
